package com.anuj.greenincome.activity;
...
import com.anuj.greenincome.Utils;
import com.anuj.greenincome.bluetooth.DeviceConnector;
import com.anuj.greenincome.bluetooth.DeviceListActivity;
...
public final class DeviceControlActivity extends BasicActivity {
    ...
    void checkride(String msg)
    {
        clutch = Float.parseFloat(msg);
        txt.setText(msg);
        try {
            Thread.sleep(1000);
        }
